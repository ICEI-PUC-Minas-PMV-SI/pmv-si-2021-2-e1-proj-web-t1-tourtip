...
|TF-003| Cidades | Ao clicar no botão “Explorar” em "Belo Horizonte", é esperado que o usuário seja direcionado para a página "Belo Horizonte” |
|TF-004| Cidades | Ao carregar a página de “Belo Horizonte”, o usuário terá duas opções de explorar “Locais de Interesse” e/ou “Principais Categorias” |
|TF-005| Cidades | Em “Locais de Interesse” o usuário terá três opções de explorar “Lagoa da Pampulha” ou “Praça da Liberdade” ou “Mineirão”. |
|TF-006| Cidades | Ao clicar no botão "Explorar" no card de “Lagoa da Pampulha”, o usuário vai ser direcionado para a página com informações da “Lagoa da Pampulha”. |
|TF-007| Cidades | Ao clicar no botão "Explorar" no card de “Praça da Liberdade”, o usuário vai ser direcionado para a página com informações da “Praça da Liberdade”. |
|TF-008| Cidades | Ao clicar no botão "Explorar" no card de “Mineirão”, o usuário vai ser direcionado para a página com informações do “Mineirão”. |
|TF-009| Cidades | Ao clicar no botão "seta" ele retornará para a página da “Belo Horizonte”. |
|TF-010| Cidades | Em “Principais Categorias” O usuário terá três opções de explorar “Pontos Turísticos” ou “Parque Públicos” ou “Bares”. |
|TF-011| Cidades | Ao clicar no botão "Explorar" no card de “Pontos Turísticos”, o usuário vai ser direcionado para a página com os cards específicos dos “Pontos Turísticos” que estão no site.
|TF-012| Categorias | Ao carregar a página de “Pontos Turísticos”, o usuário terá várias opções de explorar os cards: “Lagoa da Pampulha”, “Mirante do Mangabeiras”, “Praça da Liberdade”, “Memorial Minas Gerais”, “Praça do Papa”, “Parque Serra do Curral”, “Casa do Baile”, “Museu de Arte da Pampulha”, “Centro Cultural do Banco do Brasil”, “Parque das Mangabeiras”, “Palácio das Artes”, “Praça da Savassi”, “Espaço do Conhecimento UFMG”, “Praça Sete de Setembro”, “Feira Hippie” e “Mercado Central” e “Mineirão ”. |
|TF-013| Categorias | Ao clicar no botão "Explorar", em um dos cards dos “Pontos Turísticos” acima o usuário vai ser direcionado para a página com as informações do Ponto Turístico Escolhido. |
|TF-014| Categorias | Ao clicar no botão "seta" ele retornará para a página “Pontos turísticos em BH”. |
|TF-015| Categorias | Ao clicar no botão "seta" ele retornará para a página “Belo Horizonte”. |
|TF-016| Cidades | Ao clicar no botão "Explorar" no card de “Parques Públicos”, o usuário vai ser direcionado para a página com os cards específicos dos “Parques Públicos” que estão no site.
|TF-017| Categorias | Ao carregar a página de “Parques Públicos”, o usuário terá várias opções de explorar os cards: “Parque Municipal Américo Renné Giannetti”, “Parque Municipal das Mangabeiras”, “Parque Municipal Jacques Cousteau”, “Parque Ecológico e Cultural Professor Marcos Mazzoni”, “Parque Municipal Fazenda Lagoa do Nado”, “Parque Cássia Eller”, “Parque Ecológico Roberto Burle Marx - Parque da Águas”, “Parque Renato Azevedo”, “Parque Ecológico Francisco Lins do Rêgo”, “Parque Amilcar Vianna Martins” e “Fundação de Parques Municipais e Zoobotânica de Belo Horizonte”. |
|TF-018| Categorias | Ao clicar no botão "Explorar", em um dos cards dos “Parques Públicos” acima o usuário vai ser direcionado para a página com as informações do Parque Escolhido. |
|TF-019| Categorias | Ao clicar no botão "seta" ele retornar na página “Parques públicos em BH”. |
|TF-020| Categorias | Ao clicar no botão "seta" ele retornará para a página “Belo Horizonte”. |
|TF-021| Cidades | Ao clicar no botão "Explorar" no card de “Bares”, o usuário vai ser direcionado para a página com os cards específicos dos Bares que estão no site.
|TF-022| Categorias | Ao carregar a página de “Bares”, o usuário terá várias opções de explorar os cards: “Jack Rock Bar”, “Bar do Museu Clube da Esquina”, “Bar Entre Folhas”, “Pompéu Bar”, “Underground Black Pub”, “Jângal”, “Café com Letras”, “Mr. Hoppy”, “Saruê”. |
...
|TF-029| Categorias | Ao clicar no botão "Explorar", em um dos cards dos “cinemas”, o usuário vai ser direcionado para a página com as informações do local do “Cinema” escolhido. |
 |TF-030| Categorias | Ao clicar no botão "seta" ele retornará na página “Locais em BH, Betim e Contagem”. |
|TF-031| Categorias | Ao clicar no botão "seta" ele retornará na página das “Categorias”: “Cinemas”/ “Bares”/ “Restaurantes”/ “Museus”/ “Parques Públicos”/ “Pontos Turísticos”. |
|TF-032| Categorias | Ao carregar a página de “Bares”, o usuário terá várias opções de explorar os cards dos Bares: “Jack Rock Bar, Bar do Museu Clube da Esquina, Bar Entre Folhas, Pompéu Bar, Underground Black Pub, Jângal, Café com Letras, Mr. Hoppy, Saruê”, bem como as opções dos bares dos municípios de Betim e Contagem. |
