...
|Eu, Sandra de Paula como Professora de História.|Quero um site prático e fácil| Desejo um site que reúne todas a informações turísticas relevantes sobre o local.| Para pesquisar sobre a viajem sem necessariamente usar aplicativos ou ficar presa ao smartphone.
